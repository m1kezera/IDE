# 📄 Lumina IDE v5.1 — Project Y (Backend)

Este documento contém o código-fonte integral do motor nativo (v5.1).
...
async def terminal_websocket(websocket: WebSocket, port: str):
    ...
    try:
        ...
        # 80x24 é o tamanho padrão inicial
    ...
    try:
        while True:
            # Recebe a digitação do usuário e injeta diretamente no PowerShell
