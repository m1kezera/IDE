...
```text
# PulsyCE Backend Configuration
OLLAMA_HOST=127.0.0.1
OLLAMA_PORT=11434
DATABASE_URL=sqlite:///pulsyce.db

# Cloud API Key (generic — any provider: OpenAI, Anthropic, Groq, etc.)
...
a = Analysis(
    ['C:\\pulsyce\\scripts\\..\\backend\\main.py'],
    pathex=[],
    binaries=[],
    datas=[('C:\\pulsyce\\scripts\\..\\backend\\.env', '.')],
    hiddenimports=['uvicorn.logging', 'uvicorn.loops', 'uvicorn.loops.auto', 'uvicorn.protocols', 'uvicorn.protocols.http', 'uvicorn.protocols.http.auto', 'uvicorn.protocols.websockets', 'uvicorn.protocols.websockets.auto', 'uvicorn.lifespan', 'uvicorn.lifespan.on', 'uvicorn.lifespan.off', 'sqlmodel', 'pydantic_settings', 'tiktoken', 'tiktoken_ext', 'tiktoken_ext.openai_public', 'dotenv', 'websockets'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
