# Código Fonte Backend Completo - Lumina IDE (v2.2.1)

> Este documento representa a versão 2.2.1 (Stability & Portability Patch), consolidando a limpeza de recursos no watcher e dinamização de caminhos de proteção.
...
class FileWatcherHandler(FileSystemEventHandler):
    ...
    def shutdown(self):
        ...
        logger.info("Watcher Handler executor shutdown completed.")
