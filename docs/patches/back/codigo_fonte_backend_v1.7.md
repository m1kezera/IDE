# Código Fonte Backend Completo - Lumina IDE (v1.7)

> Este documento contém o dump de todo o código-fonte atual exclusivo do Backend em Python da Lumina IDE, incluindo o servidor FastAPI, integrações com Ollama/Cloud, Telemetria, Sistema de Memória SQLModel e Websockets com PTY/Subprocess.

## Backend - Motor Python FastAPI da Lumina IDE v1.7
