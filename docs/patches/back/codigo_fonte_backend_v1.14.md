# Código Fonte Backend Completo - Lumina IDE (v1.14)

> Este documento contém o dump de todo o código-fonte atual exclusivo do Backend em Python da Lumina IDE, refletindo a versão 1.14 com a implementação do Lumina Library (Ingestão de Documentação Técnica via PyMuPDF).

## Backend - Motor Python FastAPI da Lumina IDE v1.14 (Lumina Library & Ingestão)
