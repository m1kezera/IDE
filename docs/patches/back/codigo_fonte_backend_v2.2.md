# Código Fonte Backend Completo - Lumina IDE (v2.2)

> Este documento representa a versão 2.2 (Lumina Speed & Pulse), consolidando o Smart Watcher, Pulse Batching e Otimizações de Performance.
...
async def lifespan(app: FastAPI):
        ...
        with get_session_direct() as session:
            ...
            if identity:
                ...
                if brain.verify_identity(identity.user_name, comp_hash):
                    ...
                    # Automatic protection of .env in current directory (and children)
                    protect_project_secrets("c:/pulsyce/backend", identity.user_name)
                    log.info("🛡️ Project secrets protected (.env vaulted)")
                else:
    ...
    try:
        ...
        log.error(f"Erro ao desligar Mesh: {e}")
...
### `backend/build/lumina-backend/warn-lumina-backend.txt`
...
missing module named pwd - imported by posixpath (delayed, conditional), shutil (optional), tarfile (optional), pathlib (delayed, conditional, optional), subprocess (optional), netrc (delayed, conditional), getpass (delayed), webbrowser (delayed)
...
missing module named pyimod02_importers - imported by C:\pulsyce\backend\.venv\Lib\site-packages\PyInstaller\hooks\rthooks\pyi_rth_pkgutil.py (delayed)
...
missing module named blobfile - imported by tiktoken.load (delayed, optional)
missing module named regex.DEFAULT_VERSION - imported by regex (delayed, optional), regex._main (delayed, optional)
missing module named 'numpy.typing' - imported by tiktoken.core (conditional)
missing module named numpy - imported by tiktoken.core (delayed, conditional)
...
missing module named pydantic.PydanticSchemaGenerationError - imported by pydantic (delayed), pydantic.functional_validators (delayed, conditional), fastapi._compat.v2 (top-level)
missing module named pydantic.BaseModel - imported by pydantic (conditional), pydantic._internal._typing_extra (conditional), pydantic._internal._import_utils (delayed, conditional), pydantic._internal._core_utils (delayed), pydantic.deprecated.copy_internals (delayed, conditional), fastapi.exceptions (top-level), fastapi.types (top-level), fastapi._compat.shared (top-level), fastapi._compat.v2 (top-level), fastapi.openapi.models (top-level), fastapi.security.http (top-level), fastapi.dependencies.utils (top-level), fastapi.encoders (top-level), fastapi.openapi.utils (top-level), sqlmodel.main (top-level), sqlmodel._compat (top-level), pydantic_settings.sources.base (top-level), pydantic_settings.sources.utils (top-level), pydantic_settings.sources.providers.cli (top-level), router (top-level), workspace (top-level)
...
missing module named annotationlib - imported by typing_extensions (conditional), pydantic._internal._typing_extra (conditional), pydantic._internal._decorators (delayed, conditional), pydantic._internal._model_construction (delayed, conditional), fastapi.dependencies.utils (delayed, conditional, optional), sqlalchemy.util.compat (conditional), sqlmodel._compat (delayed, conditional)
missing module named toml - imported by pydantic.v1.mypy (delayed, conditional, optional)
missing module named tomli - imported by pydantic_settings.sources.providers.toml (delayed, conditional, optional), pydantic.mypy (delayed, conditional, optional), pydantic.v1.mypy (delayed, conditional, optional)
missing module named tomllib - imported by pydantic_settings.sources.providers.toml (delayed, conditional), pydantic.mypy (delayed, conditional), pydantic.v1.mypy (delayed, conditional)
...
missing module named yaml - imported by pydantic_settings.sources.providers.yaml (delayed, conditional, optional), uvicorn.config (delayed, conditional)
missing module named 'google.cloud' - imported by pydantic_settings.sources.providers.gcp (delayed, conditional, optional)
missing module named 'google.auth' - imported by pydantic_settings.sources.providers.gcp (delayed, conditional, optional)
missing module named google - imported by pydantic_settings.sources.providers.gcp (conditional)
...
missing module named sniffio - imported by anyio._core._eventloop (optional)
...
### `backend/dist/lumina-backend/_internal/importlib_metadata-8.7.1.dist-info/top_level.txt`

```
importlib_metadata
```

### `backend/dist/lumina-backend/_internal/websockets-15.0.1.dist-info/entry_points.txt`
...
### `backend/dist/lumina-backend/_internal/websockets-15.0.1.dist-info/top_level.txt`
