# Código Fonte Frontend Completo - Lumina IDE (v2.3.3)

> Este documento contém o dump de todo o código-fonte atual exclusivo do Frontend (React + Vite) e do Electron da Lumina IDE, refletindo a versão 2.3.3 sincronizada no Porto 8001.

## Frontend - Interface React da Lumina IDE v2.3.3 (Adaptive Listening)
...
## Electron - Configurações de Desktop da Lumina IDE v2.3.3
