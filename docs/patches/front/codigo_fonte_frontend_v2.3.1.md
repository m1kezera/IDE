# Código Fonte Frontend Completo - Lumina IDE (v2.3.1)

> Este documento representa a versão 2.3.1 (UX Masterclass), incluindo animações GSAP, neon motor pulses e badges de performance.
