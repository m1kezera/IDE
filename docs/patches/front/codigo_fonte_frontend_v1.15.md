# Código Fonte Frontend Completo - Lumina IDE (v1.15)

> Este documento contém o dump de todo o código-fonte atual exclusivo do Frontend (React + Vite) e do Electron da Lumina IDE, refletindo a versão 1.15 com o visual overhaul Lumina Blue e ícones Lucide.

## Frontend - Interface React da Lumina IDE v1.15 (Lumina Blue & Visual Overhaul)
...
export default function App() {
    ...
    return (
        <div className="ide-layout">
            ...
            <StatusBar
                mode={mode}
                model={activeTabDetails?.model || model}
                workspace={workspace}
...
export default function StatusBar({ mode, model, workspace, tokenCount, bypassProtection, memoryStatus, onEdgeClick }) {
...
## Electron - Configurações de Desktop da Lumina IDE v1.15
